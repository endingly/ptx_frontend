...
M9 的 machine-readable opcode manifest、simulator MVP corpus、bare `ret`、bare `exit` 与 bare
`trap` MVP slice 已完成；下一项为 M9-I06 `and`。M8-I14 继续暂停。
