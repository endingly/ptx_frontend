...
M9 的 machine-readable opcode manifest 与 simulator MVP corpus 已完成，下一步按 corpus
逐项实现核心 opcode slice；M8-I14 继续暂停。
...
2. 按 simulator MVP corpus 逐个实现 M9 opcode slice；
