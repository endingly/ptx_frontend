...
description: Review ptx_frontend architecture or core-contract changes and their acceptance. Use for proposed PTX semantic, IR/API, generator, or acceptance-policy changes; not routine explanations, spelling-only edits, or non-core checks.
---
