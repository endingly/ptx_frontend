...
[Explicit floating MAD](mad_coverage.md), [DIV](div_coverage.md), and [reciprocal/square-root forms](unary_float_coverage.md) are now modelled separately. The remaining Issue 142 work covers transcendentals, MIN/MAX, and an audit of existing ADD/SUB and mixed-family contracts. None of those operations gains execution semantics here.
