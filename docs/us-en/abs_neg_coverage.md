...
[Explicit floating MAD](mad_coverage.md) is now modelled separately. The remaining Issue 142 work covers DIV, reciprocal and square-root operations, transcendentals, MIN/MAX, and an audit of existing ADD/SUB and mixed-family contracts. None of those operations gains execution semantics here.
