...
[Explicit floating MAD](mad_coverage.md), [DIV](div_coverage.md), [reciprocal/square-root forms](unary_float_coverage.md), [floating transcendentals](transcendental_coverage.md), and [floating MIN/MAX](min_max_coverage.md) are now modelled separately. [Floating and mixed ADD/SUB](add_sub_coverage.md) reconciles the remaining §9.7.3–§9.7.5 cohorts. None of those operations gains execution semantics here.
