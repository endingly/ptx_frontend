...
The remaining Issue 142 work covers MAD/DIV, reciprocal and square-root operations, transcendentals, MIN/MAX, and an audit of existing ADD/SUB and mixed-family contracts. None of those operations gains execution semantics here.
