...
[Explicit reciprocal and square-root forms](unary_float_coverage.md), [floating transcendentals](transcendental_coverage.md), and [floating MIN/MAX](min_max_coverage.md) are now modelled separately. The existing ADD/SUB audit remains outside this document's scope.
