...
| PTX 9.3 `prefetch` / `prefetchu` | Supported | Ordinary generic/global/local L1/L2 forms, global L2 eviction priority, const/param tensor-map forms, and uniform-cache L1. See [prefetch coverage](prefetch_coverage.md). |
