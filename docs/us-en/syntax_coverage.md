...
| Ordinary `set` | Supported | Scalar result/source types, comparison and Boolean domains, `.ftz`, and `.f64` target minimum are documented in [SET coverage](set_coverage.md); half/bfloat forms remain outside this slice |
