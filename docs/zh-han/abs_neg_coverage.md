...
Issue 142 剩余工作会覆盖 MAD/DIV、reciprocal 与 square-root、transcendental、MIN/MAX，以及既有 ADD/SUB 与 mixed-family contract 的审计。这里不添加这些 operation 的 execution semantics。
