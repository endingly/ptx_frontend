...
[explicit 浮点 MAD](mad_coverage.md)、[DIV](div_coverage.md) 与 [reciprocal/square-root form](unary_float_coverage.md) 已单独建模。Issue 142 剩余工作会覆盖 transcendental、MIN/MAX，以及既有 ADD/SUB 与 mixed-family contract 的审计。这里不添加这些 operation 的 execution semantics。
