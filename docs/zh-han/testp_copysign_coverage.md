...
[explicit 浮点 MAD](mad_coverage.md)、[DIV](div_coverage.md) 与
[reciprocal/square-root form](unary_float_coverage.md) 已单独建模。Issue 142 后续工作会处理
transcendental、MIN/MAX，以及现有 ADD/SUB 与 mixed-family
