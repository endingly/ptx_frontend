...
CMake target `ptx_frontend::resolved_ir`. The source covers a targeted module
with these representative forms:
...
owned model after the source, parser, and AST have left scope.
