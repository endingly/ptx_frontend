...
def generate_resolved_ir_checker_category_declarations_header(
    ...
    includes = "\n".join(
        f"#include <ptx_frontend/resolved_ir/model/{category}/{opcode}/checker.gen.hpp>"
...
def generate_resolved_ir_checker_opcode_declarations_header(
    context: GenerationContext, *, category: str, opcode: str, output_path: Path
) -> None:
    """Generate one self-contained checker specialization declaration leaf."""
    ...
    declaration = emit_check_specialization_declaration(instructions[0])
    output_path.parent.mkdir(parents=True, exist_ok=True)
    output_path.write_text(
        f"""\\
// Generated by python/scripts/gen_all.py. Do not edit.
