...
EXPECTED_SECTIONS = {
    "arithmetic.yaml": {
        ...
        "subc": {"9.7.2.4"},
        "madc": {"9.7.2.6"},
        "mul": {"9.7.1.3", "9.7.3.5", "9.7.4.3"}, "mad": {"9.7.1.4", "9.7.2.5", "9.7.3.7"},
        "clmad": {"9.7.1.5"}, "mul24": {"9.7.1.6"}, "mad24": {"9.7.1.7"},
        "sad": {"9.7.1.8"},
        ...
        "popc": {"9.7.1.15"},
        "clz": {"9.7.1.16"},
        "bfind": {"9.7.1.17"}, "fns": {"9.7.1.18"}, "brev": {"9.7.1.19"}, "bfe": {"9.7.1.20"}, "bfi": {"9.7.1.21"},
        "szext": {"9.7.1.22"}, "bmsk": {"9.7.1.23"}, "dp4a": {"9.7.1.24"}, "dp2a": {"9.7.1.25"},
    ...
    "logic_and_shift.yaml": {
        ...
        "not": {"9.7.8.4"}, "cnot": {"9.7.8.5"}, "lop3": {"9.7.8.6"}, "shf": {"9.7.8.7"}, "shl": {"9.7.8.8"}, "shr": {"9.7.8.9"},
    },
