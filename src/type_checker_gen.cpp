...
void TypeCheckerGen::check_cvt_pack(const InstrCvtPack<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U8, ScalarType::S8}); return is_one_of(instr.data.to, _allowed); }()))) { return false; }
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::S32, ScalarType::U32}); return is_one_of(instr.data.from, _allowed); }()))) { return false; }
    return true;
  };
  if (!(check_v0())) {
...
void TypeCheckerGen::check_fma(const InstrFma<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!((instr.data.type_ == ScalarType::F32))) { return false; }
  ...
  auto check_v1 = [&]() -> bool {
    ...
    if (!((instr.data.type_ == ScalarType::F64))) { return false; }
  ...
  auto check_v2 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::F16, ScalarType::F16x2}); return is_one_of(instr.data.type_, _allowed); }()))) { return false; }
  ...
  auto check_v3 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::BF16, ScalarType::BF16x2}); return is_one_of(instr.data.type_, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_ex2(const InstrEx2<ResolvedOp>& instr) {
  ...
  auto check_v1 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::F16, ScalarType::F16x2, ScalarType::BF16, ScalarType::BF16x2}); return is_one_of(instr.data.type_, _allowed); }()))) { return false; }
    return true;
  };
  if (!(check_v0() || check_v1())) {
...
void TypeCheckerGen::check_tanh(const InstrTanh<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!((instr.data == ScalarType::F32))) { return false; }
  ...
  auto check_v1 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::F16, ScalarType::F16x2, ScalarType::BF16, ScalarType::BF16x2}); return is_one_of(instr.data, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_copysign(const InstrCopysign<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::F32, ScalarType::F64}); return is_one_of(instr.data, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_add(const InstrAdd<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U16, ScalarType::U64, ScalarType::S16, ScalarType::S64, ScalarType::U32, ScalarType::S32}); return is_one_of(d.type_, _allowed); }()))) { return false; }
  ...
  auto check_v1 = [&]() -> bool {
    ...
    if (!std::holds_alternative<ArithInteger>(instr.data)) return false;
    [[maybe_unused]] auto& d = std::get<ArithInteger>(instr.data);
    if (!((d.saturate == true))) { return false; }
    if (!((d.type_ == ScalarType::S32))) { return false; }
  ...
  auto check_v2 = [&]() -> bool {
    ...
    if (!std::holds_alternative<ArithInteger>(instr.data)) return false;
    [[maybe_unused]] auto& d = std::get<ArithInteger>(instr.data);
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U16x2, ScalarType::S16x2}); return is_one_of(d.type_, _allowed); }()))) { return false; }
  ...
  auto check_v3 = [&]() -> bool {
    ...
    if (!std::holds_alternative<ArithInteger>(instr.data)) return false;
    [[maybe_unused]] auto& d = std::get<ArithInteger>(instr.data);
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U8x4, ScalarType::S8x4}); return is_one_of(d.type_, _allowed); }()))) { return false; }
  ...
  auto check_v4 = [&]() -> bool {
    ...
    [[maybe_unused]] auto& d = std::get<ArithInteger>(instr.data);
    if (!((d.saturate == true))) { return false; }
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U16x2, ScalarType::S16x2, ScalarType::U32}); return is_one_of(d.type_, _allowed); }()))) { return false; }
  ...
  auto check_v5 = [&]() -> bool {
    ...
    if (!((d.type_ == ScalarType::F32))) { return false; }
  ...
  auto check_v6 = [&]() -> bool {
    ...
    if (!std::holds_alternative<ArithFloat>(instr.data)) return false;
    [[maybe_unused]] auto& d = std::get<ArithFloat>(instr.data);
    if (!((d.type_ == ScalarType::F64))) { return false; }
  ...
  auto check_v7 = [&]() -> bool {
    ...
    if (!std::holds_alternative<ArithFloat>(instr.data)) return false;
    [[maybe_unused]] auto& d = std::get<ArithFloat>(instr.data);
    if (!((d.type_ == ScalarType::F32x2))) { return false; }
  ...
  auto check_v8 = [&]() -> bool {
    ...
    if (!std::holds_alternative<ArithFloat>(instr.data)) return false;
    [[maybe_unused]] auto& d = std::get<ArithFloat>(instr.data);
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::F16, ScalarType::F16x2}); return is_one_of(d.type_, _allowed); }()))) { return false; }
  ...
  auto check_v9 = [&]() -> bool {
    ...
    if (!std::holds_alternative<ArithFloat>(instr.data)) return false;
    [[maybe_unused]] auto& d = std::get<ArithFloat>(instr.data);
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::BF16, ScalarType::BF16x2}); return is_one_of(d.type_, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_sub(const InstrSub<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!std::holds_alternative<ArithInteger>(instr.data)) return false;
    [[maybe_unused]] auto& d = std::get<ArithInteger>(instr.data);
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U16, ScalarType::U32, ScalarType::U64, ScalarType::S16, ScalarType::S64, ScalarType::S32}); return is_one_of(d.type_, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_mul(const InstrMul<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<MulIntControl>({MulIntControl::High, MulIntControl::Low}); return is_one_of(d.control, _allowed); }()))) { return false; }
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U16, ScalarType::U32, ScalarType::U64, ScalarType::S16, ScalarType::S32, ScalarType::S64}); return is_one_of(d.type_, _allowed); }()))) { return false; }
  ...
  auto check_v1 = [&]() -> bool {
    ...
    if (!std::holds_alternative<MulInt>(instr.data)) return false;
    [[maybe_unused]] auto& d = std::get<MulInt>(instr.data);
    if (!((d.control == MulIntControl::Wide))) { return false; }
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U16, ScalarType::U32, ScalarType::S16, ScalarType::S32}); return is_one_of(d.type_, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_mad(const InstrMad<ResolvedOp>& instr) {
  ...
  auto check_v2 = [&]() -> bool {
    ...
    if (!std::holds_alternative<MadInt>(instr.data)) return false;
    [[maybe_unused]] auto& d = std::get<MadInt>(instr.data);
    if (!((d.control == MulIntControl::High))) { return false; }
    if (!((d.saturate == true))) { return false; }
    if (!((d.type_ == ScalarType::S32))) { return false; }
...
void TypeCheckerGen::check_mul24(const InstrMul24<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<Mul24Control>({Mul24Control::Hi, Mul24Control::Lo}); return is_one_of(instr.data.control, _allowed); }()))) { return false; }
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U32, ScalarType::S32}); return is_one_of(instr.data.type_, _allowed); }()))) { return false; }
    return true;
  };
  if (!(check_v0())) {
...
void TypeCheckerGen::check_sad(const InstrSad<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U16, ScalarType::U32, ScalarType::U64, ScalarType::S16, ScalarType::S32, ScalarType::S64}); return is_one_of(instr.data, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_abs(const InstrAbs<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::S16, ScalarType::S32, ScalarType::S64}); return is_one_of(instr.data.type_, _allowed); }()))) { return false; }
  ...
  auto check_v1 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::F32, ScalarType::F64}); return is_one_of(instr.data.type_, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_min(const InstrMin<ResolvedOp>& instr) {
  ...
  auto check_v2 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::F32, ScalarType::F64}); return is_one_of(d.type_, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_clz(const InstrClz<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::B32, ScalarType::B64}); return is_one_of(instr.data, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_bfe(const InstrBfe<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U32, ScalarType::U64, ScalarType::S32, ScalarType::S64}); return is_one_of(instr.data, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_bmsk(const InstrBmsk<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<BmskMode>({BmskMode::Clamp, BmskMode::Wrap}); return is_one_of(instr.data, _allowed); }()))) { return false; }
    return true;
  };
  if (!(check_v0())) {
...
void TypeCheckerGen::check_dp2a(const InstrDp2a<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<Dp2aControl>({Dp2aControl::Low, Dp2aControl::High}); return is_one_of(instr.data.control, _allowed); }()))) { return false; }
    return true;
  };
  if (!(check_v0())) {
...
void TypeCheckerGen::check_add_cc(const InstrAddExtended<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U32, ScalarType::S32, ScalarType::U64, ScalarType::S64}); return is_one_of(instr.data.type_, _allowed); }()))) { return false; }
    return true;
  };
  if (!(check_v0())) {
...
void TypeCheckerGen::check_mad_cc(const InstrMadExtended<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<MulIntControl>({MulIntControl::Low, MulIntControl::High}); return is_one_of(instr.data.control, _allowed); }()))) { return false; }
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U32, ScalarType::S32, ScalarType::U64, ScalarType::S64}); return is_one_of(instr.data.type_, _allowed); }()))) { return false; }
    return true;
  };
  if (!(check_v0())) {
...
void TypeCheckerGen::check_and(const InstrAnd<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::Pred, ScalarType::B16, ScalarType::B32, ScalarType::B64}); return is_one_of(instr.data, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_shl(const InstrShl<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::B16, ScalarType::B32, ScalarType::B64}); return is_one_of(instr.data, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_shr(const InstrShr<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::B16, ScalarType::B32, ScalarType::B64, ScalarType::U16, ScalarType::U32, ScalarType::U64, ScalarType::S16, ScalarType::S32, ScalarType::S64}); return is_one_of(instr.data.type_, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_shf(const InstrShf<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ShiftDirection>({ShiftDirection::Left, ShiftDirection::Right}); return is_one_of(instr.data.direction, _allowed); }()))) { return false; }
    if (!(([&]{ static constexpr auto _allowed = std::to_array<FunnelShiftMode>({FunnelShiftMode::Clamp, FunnelShiftMode::Wrap}); return is_one_of(instr.data.mode, _allowed); }()))) { return false; }
    return true;
  };
  if (!(check_v0())) {
...
void TypeCheckerGen::check_bfind(const InstrBfind<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U32, ScalarType::U64}); return is_one_of(instr.data.type_, _allowed); }()))) { return false; }
  ...
  auto check_v1 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::S32, ScalarType::S64}); return is_one_of(instr.data.type_, _allowed); }()))) { return false; }
...
void TypeCheckerGen::check_redux_sync(const InstrReduxSync<ResolvedOp>& instr) {
  ...
  auto check_v0 = [&]() -> bool {
    ...
    if (!(([&]{ static constexpr auto _allowed = std::to_array<ScalarType>({ScalarType::U32, ScalarType::S32, ScalarType::B32}); return is_one_of(instr.data.type_, _allowed); }()))) { return false; }
    return true;
  };
  if (!(check_v0())) {
...
void TypeCheckerGen::check_mbarrier_arrive(const InstrMbarrierArrive<ResolvedOp>& instr) {
  ...
  auto check_v1 = [&]() -> bool {
    ...
    if (!((instr.data.no_complete == true))) { return false; }
    return true;
  };
  if (!(check_v0() || check_v1())) {
